...
int main(void)
{
    SDL_Surface *screen,*texte,*retour,*retour1;
    SDL_Surface *jouer,*image,*parametre,*quitter,*personnage,*pierre,*jouer1,*parametre1,*quitter1,*volume,*volume1,*f[22];
    SDL_Surface *vol,*reso,*reso1;
    SDL_Rect postionimage,posjouer,posparametre,posquitter,postionjoueur,posretour,posvolume,posvolume1,posvol,posimage1,postexte,posanim,posretour1;
    SDL_Event event;
    char pause;
    TTF_Init();
    ...
    f[9]=IMG_Load("tt9.jpg");
    f[10]=IMG_Load("tt10.jpg");
    f[11]=IMG_Load("tt11.jpg");
    f[12]=IMG_Load("tt12.jpg");
    f[13]=IMG_Load("tt13.jpg");
    f[14]=IMG_Load("tt14.jpg");
    f[15]=IMG_Load("tt15.jpg");
    f[16]=IMG_Load("tt16.jpg");
    f[17]=IMG_Load("tt17.jpg");
    f[18]=IMG_Load("tt18.jpg");
    f[19]=IMG_Load("tt19.jpg");
    f[20]=IMG_Load("tt20.jpg");
    f[21]=IMG_Load("tt21.jpg");
    f[22]=IMG_Load("tt22.jpg");
...
posanim.x=0;
posanim.y=0;
retour1=IMG_Load("retour1.png");
                    posretour1.x=1000;
                    posretour1.y=50;
    TTF_Font *fontTest;
    fontTest=TTF_OpenFont("LemonMilk.ttf",60);
    SDL_Color fontColor= {0,0,0};
    texte= TTF_RenderText_Solid(fontTest,"CODING TEAM",fontColor);
    while(i!=22)
    {
            ...
            if((event.button.button==SDL_BUTTON_LEFT)&&(event.button.x<posparametre.x+parametre->w&&event.button.x>posparametre.x)&&(event.button.y<posparametre.y+parametre->h &&event.button.y>posparametre.y))
            {
                ...
                while((done1)&&(re))
                {
                    ...
                    case SDL_MOUSEBUTTONDOWN :
                        ...
                        if((event.button.x<posretour.x+retour->w&&event.button.x>posretour.x)&&(event.button.y<posretour.y+retour->h&&event.button.y>posretour.y))
                        {
